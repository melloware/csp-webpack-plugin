Contributing to CSP WebPack Plugin: Terms and Conditions
================================================

------------------------------------------------------------------------------

Do you want to contribute your work to CSP WebPack Plugin? Well, then first and most important: **THANK YOU!** 
...
**Important**: submitting any contributions to the CSP WebPack Plugin project implies your **full acceptance of these terms**,
including the *"CSP WebPack Plugin Individual Contributor License Agreement"* detailed at the end. 
...
First of all, **Discuss with the [project members](http://forum.CSP WebPack Plugin.org/)** (a new thread should do) about 
...
How will your relation with the CSP WebPack Plugin project be?
-----------------------------------------------------
...
Note the following only applies to documentation/articles meant to be published at the CSP WebPack Plugin website.
  ...
  - Project members may edit and make small changes to your texts --of which you will be informed-- before 
    publishing them.
  - Format and visual styles must adhere to the CSP WebPack Plugin website standards, of which you will be informed
...
All CSP WebPack Plugin software is distributed under the **MIT** open source license, and your contributions
...
explained in this page, and that it both authorises your contribution to CSP WebPack Plugin and states that will 
never claim any kind of rights over it.



CSP WebPack Plugin Individual Contributor License Agreement
--------------------------------------------------

This contributor agreement ("Agreement") documents the rights granted by contributors to the CSP WebPack Plugin Project. 

This is a legally binding document, so please read it carefully before agreeing to it. The Agreement
may cover more than one software project managed by CSP WebPack Plugin.

### 1. Definitions

  * _"CSP WebPack Plugin"_ means the "CSP WebPack Plugin Project organization and members".
  * _"You"_ means the individual who submits a Contribution to CSP WebPack Plugin.
  * _"Contribution"_ means any work of authorship that is submitted by you to CSP WebPack Plugin in which you own
  ...
  * _"Material"_ means the work of authorship which is made available by CSP WebPack Plugin to third parties. When
    ...
    in the Material.
  * _"Submit"_ means any form of electronic, verbal, or written communication sent to CSP WebPack Plugin or its
    representatives, including but not limited to electronic mailing lists, source code control systems,
    and issue tracking systems that are managed by, or on behalf of, CSP WebPack Plugin for the purpose of discussing
  ...
  * _"Submission Date"_ means the date on which you submit a Contribution to CSP WebPack Plugin.
  * _"Effective Date"_ means the date you execute this agreement or the date You first submit a
    Contribution to CSP WebPack Plugin, whichever is earlier.
...
#### 2.1. Copyright License
    ...
    (b) To the maximum extent permitted by the relevant law, you grant to CSP WebPack Plugin a perpetual, worldwide,
...
own, control or have the right to grant, now or in the future, you grant to CSP WebPack Plugin a perpetual, worldwide,
...
As a condition on the grant of rights in Sections 2.1 and 2.2, CSP WebPack Plugin agrees to license the Contribution only
...
to assert such moral rights against CSP WebPack Plugin or its successors in interest, or any of our licensees, either 
direct or indirect.


#### 2.5 CSP WebPack Plugin Rights 

You acknowledge that CSP WebPack Plugin is not obligated to use your Contribution as part of the
Material and may decide to include any Contributions CSP WebPack Plugin considers appropriate.
...
FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT ARE EXPRESSLY DISCLAIMED BY YOU TO CSP WebPack Plugin AND BY
CSP WebPack Plugin TO YOU. TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN 
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL YOU OR CSP WebPack Plugin BE LIABLE FOR ANY LOSS OF 
...
### 6. Miscellaneous
    ...
    6.2 This Agreement sets out the entire agreement between you and CSP WebPack Plugin for your Contributions to
        CSP WebPack Plugin and overrides all other agreements or understandings.
    6.3 If You or CSP WebPack Plugin assign the rights or obligations received through this Agreement to a third party, 
